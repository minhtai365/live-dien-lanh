...
function MWEditor({ mode, content, setContent }) {
    ...
    const editorConfig = {
        plugins: [Essentials, Table, TableToolbar, Link, Paragraph, Alignment, Heading, Image, Bold, ImageResize, Italic, ImageUpload, ImageToolbar, ImageStyle, ImageCaption, BlockQuote, List],
