...
class MainHome extends Component {
    ...
    async componentDidMount() {
        if (this.props.cateproduct.length === 0 || !this.props.topview.length === 0) {
            ...
            this.setState({ cateproduct: this.props.cateproduct, topview: this.props.topview, isLoading: false });
        }
    }
    getHomeProduct = async (search) => {
        ...
        if (response) {
            ...
            this.setState({ cateproduct: response.cateproduct, topview: response.topview, isLoading: false })
        }
        else {
        }
    }
